...
const {
  ...
  getEventById,
  updateEvent,
  deactivateEvent, // gunakan deactivateEvent, bukan deleteEvent
  scanAttendance,
  uploadCertificate,
  getRegistrationsByEvent
} = require('../controllers/panitiaController');
// untuk tim keuangan
...
// Ubah delete menjadi PATCH untuk nonaktifkan event
router.patch('/event/:id/deactivate', protect, checkRole(['panitia']), deactivateEvent);
