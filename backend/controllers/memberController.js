...
exports.getMemberDashboard = async (req, res) => {
  try {
    ...
    const registrations = await Registration.find({ user: userId })
      ...
      .sort({ waktuDaftar: -1 }); // sort dari terbaru
...
// Mendaftar ke event: generate kode pembayaran
...
// Upload bukti pembayaran berupa link
