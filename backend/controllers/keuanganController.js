...
const updatePaymentStatus = async (req, res) => {
  try {
    const { kodePembayaran, paymentStatus } = req.body; // paymentStatus: 'paid' atau 'pending'

    // Temukan registration berdasarkan kodePembayaran
    ...
    // Jika status menjadi 'paid' dan bukti pembayaran sudah terupload (buktiBayar tidak null)
